// https://github.com/mygit03/ShutDown/blob/master/mytrayicon.cpp
...
{
    minAct = new QAction(QString("Gizle"), this);
    connect(minAct, SIGNAL(triggered()), parent, SLOT(hide()));
    maxAct = new QAction(QString("Göster"), this);
    connect(maxAct, SIGNAL(triggered()), parent, SLOT(show()));
    quitAct = new QAction(QString("Çıkış"), this);
